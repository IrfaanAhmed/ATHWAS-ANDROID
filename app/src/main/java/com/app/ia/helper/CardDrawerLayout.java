...
public class CardDrawerLayout extends DrawerLayout {
    ...
    public CardDrawerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);

    }

    public CardDrawerLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        addDrawerListener(new DrawerListener() {
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
                CardDrawerLayout.this.drawerView = drawerView;
