...
import com.app.ia.R
import com.app.ia.callback.PageIndicator
...
class CirclePageIndicator @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = R.attr.vpiCirclePageIndicatorStyle) : View(context, attrs, defStyle), PageIndicator {
    ...
    companion object {
        ...
        /**
         * This section is used for defining global variables and objects
         * which will be later used in all over class
         */
        private const val INVALID_POINTER = -1
    }
}
/**
 * Constructor declaration of CirclePageIndicator class
 *
 * @param context
 */